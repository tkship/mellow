            ...
            Expanded(
              child: Transform.scale(
                ...
                child: Stack(
                  children: <Widget>[
                    Image.asset(
                      "assets/vignettes/constellations_list/${widget.data.image}-Constellation@2x.png",
                      filterQuality: FilterQuality.high,
                    ),
                    Opacity(
                      opacity: _textAlphaTween.value,
                      child:
                          Image.asset("assets/vignettes/constellations_list/${widget.data.image}-Text@2x.png", fit: BoxFit.contain),
                    ),
                  ],
                ),
              ),
