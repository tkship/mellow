...
class _ConstellationListViewState extends State<ConstellationListView> {
  ...
  Widget _buildHeaderText() {
    return Positioned(
      ...
      child: Text(
        "GUIDE TO THE STARS",
        style: TextStyle(color: Colors.white, fontSize: 28, fontFamily: Fonts.Header, height: 1.05),
      ),
    );
  }
  ...
  Positioned _buildLocationText() {
    return Positioned(
      ...
      child: Text(
        ...
        style: TextStyle(color: Colors.grey, fontSize: 10, fontFamily: Fonts.Content, height: 1.8),
      ),
    );
  }
