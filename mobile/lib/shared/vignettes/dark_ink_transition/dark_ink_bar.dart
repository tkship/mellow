...
class _DarkInkBarState extends State<DarkInkBar> with SingleTickerProviderStateMixin {
  ...
  final _moonIcon = AssetImage('assets/vignettes/dark_ink_transition/icon-moon.png');
  final _sunIcon = AssetImage('assets/vignettes/dark_ink_transition/icon-sun.png');
            ...
            child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: ImageIcon(AssetImage('assets/vignettes/dark_ink_transition/icon-r.png')),
                  ),
                  TextButton(
                    onPressed: () => _darkModeValue.value = !_darkModeValue.value,
                    style: ButtonStyle(
                      overlayColor: MaterialStatePropertyAll(Colors.transparent),
                      foregroundColor: MaterialStatePropertyAll(foregroundColor),
                    ),
